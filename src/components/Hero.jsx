    ...
    <section id="how-i-work" style={s.section}>
      <div style={s.container}>
        <div style={s.content}>
          ...
          <div style={s.body}>
            <p style={s.line}>
              <span style={s.bold}>☀️ By day:</span> I govern a $400M COGS portfolio, ship AI agent systems, and turn org-wide complexity into clarity for EVP-level decisions.
            </p>
            <p style={s.line}>
              <span style={s.bold}>🥾 By night:</span> Trail chaser. Finds clarity at elevation. Perpetual home redesigner who treats every room like a product launch.
            </p>
          </div>
          ...
          <div style={s.missionCard}>
            ...
            <p style={s.missionText}>
              Build systems that outlast you. Bring clarity to hard problems and humanity to hard conversations. Leave every org — and every team — sharper than you found it. Raise the bar, always.
            </p>
          </div>
        </div>
