const s = {
  ...
  name: { fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: 'clamp(3rem, 6vw, 4.5rem)', fontWeight: 700, color: 'var(--heading)', lineHeight: 1.1, letterSpacing: '-0.02em' },
  ...
  missionText: { fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: '1.125rem', fontStyle: 'italic', color: 'var(--fg)', lineHeight: 1.7 },
